...
export function Projects() {
  const projects = [
    {
      name: "seyiki.com",
      desc: "Company profile for PT SEIIKI",
      url: "https://seyiki.com/",
    },
    {
      name: "docs.seyiki.com",
      desc: "Document management system for PT SEIIKI",
      url: "https://docs.seyiki.com/",
    },
    {
      name: "lhpp.seyiki.com",
      desc: "LHPP report generator for PT SEIIKI",
      url: "https://lhpp.seyiki.com/",
    },
    {
      name: "survei.seyiki.com",
      desc: "Survey platform for PT SEIIKI",
      url: "https://survei.seyiki.com/",
    },
    {
      name: "iot.seyiki.com",
      desc: "IoT monitoring & control (lights/AC) for Universitas Lampung",
      url: "https://iot.seyiki.com/login",
    },
    {
      name: "gudangdistribusi.com",
      desc: "SaaS business analysis for PT MEITA GUDANG DISTRIBUSI",
      url: "https://gudangdistribusi.com/home",
    },
    {
      name: "epic.itera.ac.id",
      desc: "International Conference Website (Physics Engineering 5th)",
      url: "https://epic.itera.ac.id/",
    },
    {
      name: "km-itera.com",
      desc: "KM ITERA 2026 organization website",
      url: "https://www.km-itera.com/",
    },
    {
      name: "pemira-km-itera.my.id",
      desc: "Student president election website ITERA 2025-2026",
      url: "http://pemira-km-itera.my.id/",
    },
    {
      name: "pemira-himatekia-itera.my.id",
      desc: "Student election website for Himpunan Teknik Kimia ITERA 2025",
      url: "http://pemira-himatekia-itera.my.id/",
    },
    {
      name: "komikkuy.my.id",
      desc: "Free manga, manhua, and manhwa reading website",
      url: "http://komikkuy.my.id/",
    },
    {
      name: "lavender-bloom-invites.vercel.app",
      desc: "Wedding invitation website with elegant and modern design",
      url: "https://lavender-bloom-invites.vercel.app/",
    },
    {
      name: "travel-seven-sigma.vercel.app",
      desc: "Travel agency website Jakarta",
      url: "https://travel-seven-sigma.vercel.app/",
    },
    {
      name: "smartcenterindonesia.com",
      desc: "SaaS for SMART CENTER INDONESIA",
      url: "https://smartcenterindonesia.com/",
    },
    {
      name: "pplkitera.com",
      desc: "New student admission website ITERA 2024 & 2025",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-16 md:text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground">
            A curated list of my 20+ shipped applications, ranging from
            enterprise dashboards to corporate profiles.
          </p>
        </div>
